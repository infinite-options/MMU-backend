...
from utils import createHash, createSalt
...
class Password(Resource):
    ...
    def put(self):
        ...
        current_password_encrypted = createHash(current_password, user.get('user_password_salt'))
        if current_password_encrypted != user.get('user_password_hash'):
