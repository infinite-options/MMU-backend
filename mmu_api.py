    ...
    def get(self):
        try:
            ...
            try:
                ...
                return jsonify({
                    "message": f"Date/Time: {self.dt}. Endpoint Test CRONJOB ran successfully"
                })
            except:
                return jsonify({
            ...
            try:
                ...
                SendEmail_CLASS().get(message_content)
                return jsonify({
                    "message": f"Date/Time: {self.dt}. There was some error while running Endpoint Test CRONJOB"
                })
            except:
                return jsonify({
                    "message": f"Today's date/time: {self.dt}. There was some error while running Endpoint Test CRONJOB. Error in sending the email"
                })
...
def endpointTest_CRON():
    ...
    try:
        ...
        try:
            ...
            SendEmail_CLASS().get(message_content)
            return jsonify({
                "message": f"Date/Time: {dt}. Endpoint Test CRONJOB ran successfully"
            })
        except:
            return jsonify({
        ...
        try:
            ...
            SendEmail_CLASS().get(message_content)
            return jsonify({
                "message": f"Date/Time: {dt}. There was some error while running Endpoint Test CRONJOB"
            })
        except:
            return jsonify({
